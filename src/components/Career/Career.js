...
class Career extends React.Component{
    ...
    render(){
        return(
            <div>
      <section class="career_page_section"  style={{ 
      background: 'url("assets/image/contact.webp")'
    }}>      
<section class="services_section">
    <div class="custom_container">
        <h2>Join our team and make a difference today</h2>
    <p>In cooperation with our Transfer Service Network we can provide all sorts of Transfers. Write to uor team on the 
    email <a href="#">info@demolink.org</a> and you will be given a feedback.</p>
